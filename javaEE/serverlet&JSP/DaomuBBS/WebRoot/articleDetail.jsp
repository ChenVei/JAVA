...
<%
	...
	String sql = "select * from daomu where id = " + id;
...
<%
	...
	id = a.getRootID();
	sql = "select * from daomu where id = " + id;
	...
	if(root == null) {
 %>
This article's title not exists!!
<%
	return;
	} }
 %>
...
<meta http-equiv="MSThemeCompatible" content="Yes">
		...
		<script async="" src="http://www.google-analytics.com/analytics.js"></script><script type="text/javascript" charset="gb2312" src="./img2/adx.js"></script>
...
<script src="./img2/common.js" type="text/javascript"></script>

<script src="./img2/guanggao.php" type="text/javascript"></script>

<script src="./img2/viewthread.js" type="text/javascript"></script>
<script type="text/javascript">zoomstatus = parseInt(1);</script>
<script type="text/javascript">
    var favor_url = 'http://bbs.51cto.com/viewthread.php?tid=1160254';
    var favor_title = '新人的困惑';
    var favor_fuid = '10238909';
</script>
<script src="./img2/favorbox.js" type="text/javascript"></script>
<!-- 2013060606 -->
<link href="./img2/shCore.css" type="text/css" rel="stylesheet">   
<link href="./img2/shThemeDefault.css" type="text/css" rel="stylesheet">   
<script src="./img2/shCore.js" type="text/javascript"></script>   
...
(function($){
	...
	$(function(){
		...
		//alert('d');
		$("#srchtxt").one('click', function(){
			$(this).val('').css({color:'#000'});
		});
			
		$('#srchtxt').bind('blur', function(){	
			if ('' == $(this).val()) {
				$(this).val(show_name).css({color:'#ccc'});
			}
		}).bind('focus', function(){
			$(this).val('').css({color:'#000'});		
		});
...
<!-- 帖子主题 -->						<h2 style="float: left;font-size:16px;vertical-align:middle">&nbsp;&nbsp;<strong><a title="<%= root.getCont() %>" href="./img2/detail.htm"><%= root.getCont() %></a></strong>&nbsp;&nbsp;<a style="text-decoration: none;font-size:12px;color:grey" href="javascript:setcopy('http://bbs.51cto.com/thread-1160254-1.html','复制帖子链接到剪贴板');">[复制链接]</a></h2>
		...
		<div class="hfbox" style="position:relative">
			...
			<a name="hf">
				...
				<td height="150" align="left" valign="middle"><label>
					 ...
					 <div class="Postban"><a href="reply.jsp?id=<%=a.getId()%>&rootID=<%=root.getId() %>">立即回复</a></div>
...
<!-- 2013060606 -->
<script src="./img2/shCore.js" type="text/javascript"></script>   
<script src="./img2/shBrushAS3.js" type="text/javascript"></script>   
<script src="./img2/shBrushBash.js" type="text/javascript"></script>   
<script src="./img2/shBrushCpp.js" type="text/javascript"></script>   
<script src="./img2/shBrushCSharp.js" type="text/javascript"></script>   
<script src="./img2/shBrushCss.js" type="text/javascript"></script>   
<script src="./img2/shBrushDelphi.js" type="text/javascript"></script>   
<script src="./img2/shBrushDiff.js" type="text/javascript"></script>   
<script src="./img2/shBrushGroovy.js" type="text/javascript"></script>   
<script src="./img2/shBrushJava.js" type="text/javascript"></script>   
<script src="./img2/shBrushJavaFX.js" type="text/javascript"></script>   
<script src="./img2/shBrushJscript.js" type="text/javascript"></script>   
<script src="./img2/shBrushPerl.js" type="text/javascript"></script>   
<script src="./img2/shBrushPhp.js" type="text/javascript"></script>   
<script src="./img2/shBrushPlain.js" type="text/javascript"></script>   
<script src="./img2/shBrushPowerShell.js" type="text/javascript"></script>   
<script src="./img2/shBrushPython.js" type="text/javascript"></script>   
<script src="./img2/shBrushRuby.js" type="text/javascript"></script>   
<script src="./img2/shBrushScala.js" type="text/javascript"></script>   
<script src="./img2/shBrushSql.js" type="text/javascript"></script>   
<script src="./img2/shBrushVb.js" type="text/javascript"></script>   
<script src="./img2/shBrushXml.js" type="text/javascript"></script>   
