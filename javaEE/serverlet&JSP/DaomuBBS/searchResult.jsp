...
<div class="pagebox">
 ...
 <%
 	str = "&keyword="+kw;
 %>
  <li><a href="searchResult.jsp?pageNo=<%= (pageNo-1)+str%>">上一页</a></li> <li><a class="abg">第<%= pageNo%>页,共<%= pages%>页</a></li> <li><a href="searchResult.jsp?pageNo=<%= (pageNo+1)+str%>" class="next">下一页</a></li>  </ul>
</div>
