<%@page import="cn.domain.Customer"%>
...
<body style="text-align:center;">
	<div align="center">
	<form id="form" method="post" action="${pageContext.servletContext.contextPath }/servlet/EditCustomerServlet" onsubmit="return makepre()">
		...
		<table border='1' >
			...
			<tr>
				...
				<td>
					<c:forEach var="g" items="${genders }">
						<input type="radio" name="gender" value="${g }" ${g==c.gender?"checked":"" }> ${g }
					</c:forEach>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<c:forEach var="t" items="${types }">
						<input type="radio" name="type" value="${t }" ${t==c.type?"checked":"" }> ${t }
					</c:forEach>
				</td>
			</tr>
			...
			<tr>
				<td>description</td>
				<td>
					<textarea rows="30" cols="50" name="description">${c.description }</textarea>
				</td>
			</tr>
