	...
	<script type="text/javascript">
		function gotopage(currentpage) {
			if (currentpage > ${pb.totalrecord} || currentpage < 1) {
				...
				window.location.href = '${pageContext.request.contextPath}/servlet/BookServlet?method=listBook&currentpage='+currentpage+'&pagesize='+pagesize;
			}
		}
		...
		function changesize(newsize, oldsize) {
			if (newsize > ${pb.totalrecord} || newsize < 1) {
				...
				window.location.href = '${pageContext.request.contextPath}/servlet/BookServlet?method=listBook&currentpage='+currentpage+'&pagesize='+newsize;
			}
		}
	</script>
</body>
